...
export const ChatInput = ({
  ...
  return (
    <div className="p-3 md:p-4 bg-[#D1DAE9]/20 border-t border-none rounded-br-xl">
      {isBlocked ? (
        <div className="flex items-center justify-center py-4 px-4 bg-red-500/20 rounded-lg border border-red-500/50">
          <p className="text-red-400 font-bold text-center">
            🚫 You cannot send messages to this user (blocked or blocking)
          </p>
        </div>
      ) : (
